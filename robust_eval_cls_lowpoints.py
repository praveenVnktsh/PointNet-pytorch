...
def create_parser():
    ...
    parser.add_argument('--num_points', type=int, default=10, help='The number of points per object to be included in the input data')
...
if __name__ == '__main__':
    ...
    args.output_dir = './output/cls' + str(args.num_points) + '/'
